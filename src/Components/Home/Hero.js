                                ...
                                <div className="flex items-center mt-3">
                                    <div className="flex">
                                        <svg className="w-3 h-3" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M10.8586 4.71248C11.2178 3.60691 12.7819 3.60691 13.1412 4.71248L14.4246 8.66264C14.5853 9.15706 15.046 9.49182 15.5659 9.49182H19.7193C20.8818 9.49182 21.3651 10.9794 20.4247 11.6626L17.0645 14.104C16.6439 14.4095 16.4679 14.9512 16.6286 15.4456L17.912 19.3958C18.2713 20.5013 17.0059 21.4207 16.0654 20.7374L12.7052 18.2961C12.2846 17.9905 11.7151 17.9905 11.2945 18.2961L7.93434 20.7374C6.99388 21.4207 5.72851 20.5013 6.08773 19.3958L7.37121 15.4456C7.53186 14.9512 7.35587 14.4095 6.93529 14.104L3.57508 11.6626C2.63463 10.9794 3.11796 9.49182 4.28054 9.49182H8.43387C8.95372 9.49182 9.41443 9.15706 9.57508 8.66264L10.8586 4.71248Z"
                                                fill="#FFCB00"
                                            />
                                        </svg>
                                        <svg className="w-3 h-3" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <p className="ml-2 text-sm font-medium text-white">5.0 (2.5k Reviews)</p>
                                </div>
                            </div>
                        </div>

                        <div className="relative">
                            <img className="relative z-10 w-full max-w-xs ml-auto" src="https://landingfoliocom.imgix.net/store/collection/dusk/images/hero/3/phone.png" alt="" />

                            <div className="absolute -bottom-8 -left-16 z-0">
                                <div className="w-full max-w-xs">
                                    <img className="w-full" src="https://landingfoliocom.imgix.net/store/collection/dusk/images/hero/3/card-mockup.png" alt="" />
                                </div>
                            </div>
                        </div>
                    </div>
